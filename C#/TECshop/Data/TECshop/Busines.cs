...
namespace TECshop
{
    public partial class Busines : Form
    {
        public Busines()
        {
            InitializeComponent();
        ...
        private void Busines_Load(object sender, EventArgs e)
        {
    ...
    ref oMissing, ref oMissing);
        ...
        private void Busines_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
